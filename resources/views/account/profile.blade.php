                ...
                <div class="card-body">
                    <form action="{{ route('account.updateProfile') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('name', Auth::user()->name) }}" class="form-control @error('name') is-invalid @enderror" placeholder="Name" name="name" id="name" />
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="image" id="image" class="form-control  @error('email') is-invalid @enderror" placeholder="images">
                            @error('image')
                            <p class="invalid-feedback"> {{$message}}</p>
                            @enderror
                            @if (Auth::user()->image !="")
